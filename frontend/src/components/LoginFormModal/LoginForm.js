     ...
     <div className="header">
      ...
      <div className="modal-column">
        <form onSubmit={handleSubmit}>
          ...
          <div className="or">
           <p> <hr style={{display: 'inline-block', width: '100px', margin:'0', backgroundColor:'#CCC', color:'#CCC'}}/><span style={{ padding: '10px', fontSize:'15px'}}>OR</span><hr style={{display:'inline-block', width: '100px', margin:'0'}}/></p>
          </div>
